...
public final class DwnAdapter extends RecyclerView.Adapter<DwnAdapter.ViewHolder> {
    ...
    public DwnAdapter(@NonNull final ActionListener actionListener) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        if (downloadData.eta == -1) {
            ...
            holder.timeRemainingTextView.setText(DwnHelper.getETAString(context, downloadData.eta));
        }

        if (downloadData.downloadedBytesPerSecond == 0) {
            holder.downloadedBytesPerSecondTextView.setText("");
        } else {
            holder.downloadedBytesPerSecondTextView.setText(DwnHelper.getDownloadSpeedString(context, downloadData.downloadedBytesPerSecond));
        }
        ...
        switch (status) {
            case COMPLETED: {
                ...
                holder.actionButton.setOnClickListener(view -> {
                    ...
                    final CharSequence[] items = {"External Player"};
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(context)
                            ...
                            .setItems(items, (dialog, which) -> {
                                dialog.dismiss();
                                Intent intent;
                                intent = new Intent(Intent.ACTION_VIEW, Uri.parse(downloadData.download.getFile()));
...
//        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final ImageView actionButtonDelete;
        ...
        ViewHolder(View itemView) {
            ...
            actionButtonDelete = itemView.findViewById(R.id.actionButtonDelete);
